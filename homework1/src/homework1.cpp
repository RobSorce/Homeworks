...
#include <sstream>
  ...
  std_msgs::Float32 minimo;
  minimo.data=min;
  pub.publish(minimo);

  ros::spinOnce();

  ROS_INFO("Minimo: %f", minimo.data);
  }
...
int main(int argc, char **argv)
{
   ...
   */
  ros::Publisher pub = n.advertise<std_msgs::Float32>("min_dist", 1);
  ros::Subscriber sub = n.subscribe<sensor_msgs::LaserScan>("base_scan", 1000, boost::bind(chatterCallback, _1, pub));
